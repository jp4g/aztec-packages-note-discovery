...
template <typename Builder> inline constexpr size_t MULTI_SCALAR_MUL = 3580 + ZERO_GATE;
template <typename Builder> inline constexpr size_t EC_ADD = 112 + ZERO_GATE + MEGA_OFFSET<Builder>;
...
inline constexpr size_t CHONK_RECURSION_GATES = 2412867;
...
inline constexpr size_t INNER_KERNEL_GATE_COUNT_HN = 60457;
...
inline constexpr size_t TAIL_KERNEL_GATE_COUNT = 33700;
...
inline constexpr size_t HIDING_KERNEL_GATE_COUNT = 36840;
