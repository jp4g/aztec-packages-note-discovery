...
export const RECURSIVE_ROLLUP_HONK_PROOF_LENGTH = 523;
export const NESTED_RECURSIVE_ROLLUP_HONK_PROOF_LENGTH = 523;
...
export const AVM_SUBTRACE_ID_EMITUNENCRYPTEDLOG = 256;
...
export enum GeneratorIndex {
  NOTE_HASH = 570261536,
  NOTE_HASH_NONCE = 4040695053,
  UNIQUE_NOTE_HASH = 1615905817,
  SILOED_NOTE_HASH = 3552985968,
  NOTE_NULLIFIER = 2273326939,
  MESSAGE_NULLIFIER = 4179235419,
  SILOED_NULLIFIER = 1843769845,
  PRIVATE_LOG_FIRST_FIELD = 3381826258,
  PUBLIC_LEAF_SLOT = 2853865602,
  PUBLIC_STORAGE_MAP_SLOT = 1106049611,
  PRIVATE_FUNCTION_LEAF = 3274445394,
  ...
  OVSK_M = 449371170,
  TSK_M = 4031170476,
  PUBLIC_KEYS_HASH = 349301051,
  PARTIAL_ADDRESS = 1453969891,
  CONTRACT_ADDRESS_V1 = 2091531360,
  BLOCK_HEADER_HASH = 2064783670,
  TX_REQUEST = 1076396939,
  PUBLIC_TX_HASH = 419169672,
  PRIVATE_TX_HASH = 4261301885,
  PUBLIC_CALLDATA = 388853507,
  FUNCTION_ARGS = 587126185,
  PROTOCOL_CONTRACTS = 3581307760,
  EVENT_COMMITMENT = 469373807,
  AUTHWIT_INNER = 829479065,
  AUTHWIT_OUTER = 1502324539,
  AUTHWIT_NULLIFIER = 1450992171,
  SYMMETRIC_KEY = 690840336,
  SYMMETRIC_KEY_2 = 3484314061,
  PARTIAL_NOTE_VALIDITY_COMMITMENT = 1665410974,
  INITIALIZATION_NULLIFIER = 2762319966,
  SECRET_HASH = 15484084,
  TX_NULLIFIER = 1039603495,
  SIGNATURE_PAYLOAD = 2407104296,
}