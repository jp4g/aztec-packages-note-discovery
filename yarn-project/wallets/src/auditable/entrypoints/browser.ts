...
import { LazyAccountContractsProvider } from '../../embedded/account-contract-providers/lazy.js';
import type { AccountContractsProvider } from '../../embedded/account-contract-providers/types.js';
import { type EmbeddedWalletOptions } from '../../embedded/embedded_wallet.js';
import { WalletDB } from '../../embedded/wallet_db.js';
import { AuditableEmbeddedWallet } from '../auditable_embedded_wallet.js';

export class BrowserAuditableEmbeddedWallet extends AuditableEmbeddedWallet {
  static async create<T extends BrowserAuditableEmbeddedWallet = BrowserAuditableEmbeddedWallet>(
    this: new (
      pxe: PXE,
      aztecNode: AztecNode,
      walletDB: WalletDB,
...
export { BrowserAuditableEmbeddedWallet as AuditableEmbeddedWallet };
export type { EmbeddedWalletOptions } from '../../embedded/embedded_wallet.js';
export { WalletDB } from '../../embedded/wallet_db.js';
export type { AccountType } from '../../embedded/wallet_db.js';
